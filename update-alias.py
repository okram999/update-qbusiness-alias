...
def lambda_handler(event, context):
    ...
    print(f"User found in both AWS IDC group and Confluence group: {actual_qbusiness_users}")
    ...
    print(f"User in IDC and confluence export but not in qbusiness: {user_not_in_qbusiness}")
    print(f"User in IDC and confluence export but failed to process: {user_in_both_but_failed_to_process}")
